...
*   _.first(["a", "b", "c"], 2) -> ["a", "b"]
*/
_.first = ( a, n = 1 ) => ! Array.isArray( a ) || n < 1 ? [] : n === 1 ? a[0] : ( a.slice( 0, n > a.length ? a.length : n ) );
...
*   _.last(["a", "b", "c"], 2) -> ["b", "c"]
*/
_.last = ( a, n = 1 ) => ! Array.isArray( a ) || n < 1 ? [] : n === 1 ? a[a.length - 1] : a.slice( n > a.length ? 0 : a.length - n, a.length );
...
*/
_.each = ( c, f ) => Object.keys( c ).map( k => f( c[k], k, c ) );
...
*   _.indexOf(["a","b","c"], "d") -> -1
*/
_.indexOf = ( a, v ) => parseInt( Object.keys( a ).filter( i => a[i] === v )[ 0 ] || -1 );
